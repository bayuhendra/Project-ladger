package com.ledger.infrastructure.component.xlsx;

import com.ledger.infrastructure.component.IXLSWriter;
import com.ledger.infrastructure.component.annotation.ReadableColumn;
import com.ledger.infrastructure.component.annotation.ReadableValue;
 ...
 * @param <T>
 */
public class XlsxWriter<T> implements IXLSWriter<T> {

    private final Class<T> clazz;

    private Workbook workbook = null;

    public XlsxWriter(Class<T> clazz) {
        this.clazz = clazz;
